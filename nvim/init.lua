...
vim.opt.colorcolumn = { 80, 100, 120 } -- '80, 100, 120'}
...
vim.keymap.set('n', '<C-d>', '<C-d>zz', { desc = 'Center the cursor after moving page down' })
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'Center the cursor after moving page up' })
...
vim.keymap.set({ 'n', 'v' }, '<leader>d', [["_d]], { desc = "blackhole 'd'" })
vim.keymap.set('n', '<leader>D', [["_D]], { desc = "blackhole 'D'" })
vim.keymap.set('n', '<leader>C', [["_C]], { desc = "blackhole 'C'" })
