## following variables from https://wiki.archlinux.org/index.php/Color_Bash_Prompt
# Reset
...
## Aliases
alias ls='/bin/ls --group-directories-first -lvh --color=auto' ##alias ls='ls --color=auto'
